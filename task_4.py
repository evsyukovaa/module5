...
site = int(input('Введите место в списке поступающих: '))
ball = int(input('Введите колличество баллов за экзамены: '))
if site <= 10 and ball >= 290:
    print('Поздравляем вы поступили!\nБонусом вам будет начисляться стипендия.')
elif site <= 10 and ball < 290:
    print('Поздравляем вы поступили!\nНо вам не хватило баллов для стипендии.')
else:
