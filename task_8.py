...
price = int(input('Введите стоимость квариты: '))
room = int(input('Введите площадь квариты: '))
if room >= 100 and price <= 10000000 or room >= 80 and price <= 7000000:
    print('Кваритра подходит')
else:
